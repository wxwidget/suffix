// unittest.hpp - a simple unit test framework for C++
//
// Typical usage:
//
...
//
// int main() {
//   unittest::UnitTest unittest(std::cerr, unittest::verbose);
//
//   ASSERT_TRUE(true);
//   ASSERT_FALSE(4!=4);
//   ASSERT_EQUAL(42, 42.0);
//   ASSERT_UNEQUAL(42,"43");
//
...
#define ASSERT_EQUAL(expr1,expr2)     QUNIT_COMPARE(true,true,expr1,expr2)
#define ASSERT_UNEQUAL(expr1,expr2)   QUNIT_COMPARE(true,false,expr1,expr2)
#define ASSERT_TRUE(expr)             QUNIT_COMPARE(false,true,expr,true)
#define ASSERT_FALSE(expr)            QUNIT_COMPARE(false,true,expr,false)
